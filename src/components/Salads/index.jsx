...
const index = () => {
  ...
  if (loading) {
    return (
      <div
        role="status"
        className="max-w-sm p-4 border border-gray-200 rounded-sm shadow-sm animate-pulse my-9 md:p-6 dark:border-gray-700"
      >
            ...
            >
              <div>
                ...
                <div className="p-2 text-left">
                  <small className="text-gray-500">{product.categoryId?.title}</small>
                  <Link to={`/show/${product._id}`}>
